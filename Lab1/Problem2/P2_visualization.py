...
df = pd.read_csv("Data/Windows_P2_M=1e4_n=1e5_1e6.csv")
...
plt.plot('n', 'optimize_recursion_nested_loop', data=df, marker='', color=palette(4), linewidth=2, label="Optimize_recursion_nested_loop")
